				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control form-control-sm" Item="item_code">
							...
							<div class="form-group">
								<label class="control-label">Wastage stock</label>
								<input type="text" class="form-control form-control-sm text-right" name="price">
							</div>
							<div class="form-group">
								<label class="control-label">Raw materials </label>
								<input type="text" class="form-control form-control-sm text-right" name="price">
							</div>
							<div class="form-group">
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Stock Info.</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Item: <b><?php echo $row['name'] ?></b></p>
										<p><small>Price: <b><?php echo number_format($row['price'],2) ?></b></small></p>
										<p><small>Size: <b><?php echo $row['size'] ?></b></small></p>
										<p><small>Quantity: <b><?php echo $row['description'] ?></b></small></p>
									</td>
